"""
This component is to abstract working with User, 
Role, Account, AccountHistory entities. Implement a 
concrete implementation of these classes here and in 
db_models classes. Any other components don't care how 
...
def create_user(username, email, password, confirmed=False):
    """
    Creates user and save into database. 
    Returns True if user is created, else False.
    """
    user = User(username=username, email=email, confirmed=confirmed)
    try:
